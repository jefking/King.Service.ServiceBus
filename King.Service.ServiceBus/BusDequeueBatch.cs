namespace King.Service.ServiceBus
{
    ...
    public class BusDequeueBatch<T> : DequeueBatch<T>
    {
        ...
        public BusDequeueBatch(IBusQueue queue, IProcessor<T> processor, int batchCount = 5, int minimumPeriodInSeconds = BaseTimes.MinimumStorageTiming, int maximumPeriodInSeconds = BaseTimes.MaximumStorageTiming)
